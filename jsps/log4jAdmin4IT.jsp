<%--
  Document : props.jsp
  Created on : no se
  Author : UN DIOS EN LA TIERRA
  Utilidad: permite sacar todos los niveles de log de log4j y además, modificarlos a tu antojo en caliente! Funciona en BKS y en LR
